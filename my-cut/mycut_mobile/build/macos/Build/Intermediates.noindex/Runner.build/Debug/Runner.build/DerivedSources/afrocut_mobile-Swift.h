...
#ifndef AFROCUT_MOBILE_SWIFT_H
#define AFROCUT_MOBILE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="afrocut_mobile",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14afrocut_mobile11AppDelegate")
...
SWIFT_CLASS("_TtC14afrocut_mobile17MainFlutterWindow")
